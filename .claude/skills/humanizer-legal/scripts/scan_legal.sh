...
scan_file() { # file label
  ...
  # Дословная цитата нормы — чужой текст, автором не сочинённый: стилевые
  ...
  # там мусор остаётся мусором и внутри цитаты.
