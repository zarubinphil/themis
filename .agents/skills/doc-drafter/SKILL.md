...
материалов) + путь к делу + примененные redlines; Кони не перечитывает
...
b.save("cases/.../.agent/drafts/{документ}_v1.docx")   # авто: «е»→«е», baseline в _baselines/
```
