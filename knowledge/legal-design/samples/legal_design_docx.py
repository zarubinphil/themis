...
def set_document_font(b, family):
    ...
    Только для НЕсудебных документов (договор, оферта, политика): для
    процессуальных Times New Roman задан эталоном и меняться не должен.
...
def add_footer_note(b, text, size_pt=9):
    """Нижний колонтитул LEFT. Правый нижний угол остается свободным под
