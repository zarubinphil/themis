...
на этой же машине (решение владельца 18.08.2026) и доказывает её пригодность:
...
CHUNK = 1 << 20
# ponytail: markdown_extract сам решает маршрут по расширению; берём то, что он точно умеет
