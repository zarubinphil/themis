...
# Предмет опознаётся по ЧАСТОТЕ подсказки, а не по первому вхождению в текст.
# Прецедент 21.08.2026: страницы публикаторов несут навигацию сайта («Административное
# право», «Налоги» в меню), и первое совпадение подстроки ловило именно её — три
...
#
# Порог разный, потому что подсказки разной надёжности. Многословная фраза
...
# почти каждой страницы публикатора — ему нужна частота, какую даёт только текст
# самого акта.
