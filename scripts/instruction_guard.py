...
еще 18.08.2026. Скан с такой фразой попадает в карту дела как обычный текст —
...
Юридический текст суд, ответчика, истца по имени модели не зовет никогда —
...
# «Фемида, изображенная на фронтоне суда, — символ правосудия» (проба 20.08.2026:
# шесть ложных тревог из тринадцати). Требование приказа уже стояло у слова
# «модель» — здесь та же мера, распространенная на все роли.
...
_STOCK_PHRASES = (
    ...
    # данные», «свои», «все предыдущие». Проба 20.08.2026: жесткий перечень
...
def normalize_text(text: str) -> str:
    """OCR дает переносы и разрядку; ищем по нормальной строке, не по сырому шуму."""
...
def selftest() -> int:
    ...
    obihod = [
        ...
        "Ответчик, будучи надлежаще извещенным, в суд не явился.",
        ...
        "Суд оценил модель, избранную ответчиком в обоснование расчета.",
    ]
...
def main() -> int:
    ...
    ap.add_argument("file", nargs="?", help="файл с извлеченным текстом (.txt/.md)")
